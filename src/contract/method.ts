...
export default class Method {
    ...
    onMethod(...args:any[]) {
        ...
        return {
            call: (...methodArgs:any[]) => this._call(types, args, ...methodArgs),
            pay: (...methodArgs:any[]) => this._pay(types, args, ...methodArgs),
        }
    }

    async _call(types:any[], args:any[], options = {}, callback = false) {                
    ...
    async _pay(types, args, options = {}, privateKey = this.tronWeb.defaultPrivateKey, callback = false) {
